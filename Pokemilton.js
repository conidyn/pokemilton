const students = [
  ...
  class Pokemilton {
    constructor() {
      this.name = this.generateRandomName(); // Nom unique généré en combinant deux noms 
    ...
    attack(defender) {
      const damage = Math.max(
        0,
        this.getRandomNumber(this.attackRange * this.level, this.attackRange) - defender.defenseRange
      );
